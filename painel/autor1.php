  ...
  <body>
    ...
    <footer class="col-md-10">
         <div class="container">
            ...
            <div class="copy text-center col-md-10">
              <p>
               &copy; Copyright Congresso Interdisciplinar em Pesquisa, Empreendedorismo e Inovação | 2017
                <br>
                <b>by</b> Wilson Oliver, Matias Uchôa & Douglas Toledo (IFMS-Três Lagoas) <a href='../index.php'>CIPEI</a>
              </p>
            </div>
