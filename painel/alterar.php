				...
				<div class="col-md-2">
					<div class="sidebar content-box" style="display: block;">
						<ul class="nav">
							...
							<li><a href="arquivos.html"><i class="glyphicon glyphicon-link"></i> Submissões</a></li>
						...
						<div class="col-md-12">
							<div class="content-box-large">
								<div class="panel-heading tirar-padding">
									<div class="panel-title"><h1>Alterar Dados
									</h1></div>
								</div>
										...
										<div class="col-md-10 col-md-offset-1">
											<div class="table-responsive">
												<table class="table table-condensed table-hover" data-wow-delay=".5s"> <!--tentei mudar várias linhas do bootstrap.css, por exemplo: linha 2273 do bootstrap.css "color: #3d9a97" e a linha 2286 "text-align: center;" nada acontece-->
													...
													<tbody>
														<td>
															<input id="nome" name="nome" type="text" value="<?php echo $row_dados['nome']; ?> " class="form-control"/>
														</td>
														<td>
															<input id="senha" name="senha" type="password" value=""class="form-control"/>
														</td>
														<td>
															<input id="email" name="email" type="text" value="<?php echo $row_dados['email']; ?>"class="form-control"/>
														</td>
														<td>
															<input id="instituicao" name="instituicao" type="text" value="<?php echo $row_dados['instituicao']; ?>"class="form-control"/>
														</td>
													</tbody>
												</table>
											</div> <!--table responsive-->
										</div>
										<input class="btn btn btn-perso col-md-2 col-md-offset-5" type="submit" value="Alterar">
									</form>
								</div>
